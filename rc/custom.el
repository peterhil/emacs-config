...
(custom-set-variables
 ...
 '(debug-on-error t)
 '(default-frame-alist (quote ((right-fringe . 0) (font-backend ns) (fontsize . 0) (menu-bar-lines . 1) (tool-bar-lines . 0) (border-color . "#0f0f0f") (modeline . t) (foreground-color . "#F8F8F2") (background-color . "#272822") (background-mode . dark) (cursor-color . "#73d216") (mouse-color . "#73d216"))))
