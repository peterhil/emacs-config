...
(custom-set-variables
 ...
 '(debug-on-error t)
 '(default-frame-alist (quote ((right-fringe . 0) (left-fringe) (modeline . t) (border-color . "#0f0f0f") (tool-bar-lines . 0) (menu-bar-lines . 1) (fontsize . 0) (font-backend ns) (foreground-color . "#F8F8F2") (background-color . "#272822") (background-mode . dark) (cursor-color . "#73d216") (mouse-color . "#73d216"))))
